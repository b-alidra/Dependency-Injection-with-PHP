...
require_once 'zsServiceDefinition.php';
require_once 'zsServiceReference.php';
...
class zsServiceContainer {
	 ...
	 */
	public function zsServiceContainer($config = null, $definitions = array()) {		
	 ...
	 * @return   void
	 */
	private function _initialize($configPath) {
		
		$config 	= file_get_contents ( $configPath, true );
